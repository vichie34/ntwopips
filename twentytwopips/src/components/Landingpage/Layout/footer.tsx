        ...
        <footer className="bg-[#0b0d17] text-gray-400 text-xs border-t border-gray-700 border-opacity-50 py-6 px-4">
            <div className="max-w-7xl mx-auto flex flex-col items-center space-y-4">
                ...
                <div className="flex items-center space-x-6">
                    ...
                    <img src="/images/supersport.png" alt="TwentyTwoPips" className="h-8 object-contain" />
                </div>
                ...
                <div className="text-center text-[11px] text-gray-500">
                    © 2013 - 2025 TwentyTwoPips (Pty) Ltd. All rights reserved.
                    <br />
                    TwentyTwoPips, from TradingHub, delivers{" "}
                    <a href="#" className="text-blue-400 hover:underline">live trades</a>{" "}
                    across Africa. Find out more at{" "}
                    <a href="#" className="text-blue-400 hover:underline">TwentyTwoPips</a>.
                </div>
            </div>
        </footer>
    );
